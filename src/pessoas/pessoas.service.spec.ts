...
describe('PessoasService', () => {
  ...
  describe('uploadPicture', () => {
    it(' aqui deve fazer upload corretamente da imagem a pessoa', async () =>{
        const mockFile ={
    ...
    const filePath = path.resolve(process.cwd(), 'pictures', '1.jpeg');
    ...
    it('isso deve lancar BadRequestExpeception se o aqruivo for muito pequeno', async () =>{
      //Arrange
      const mockFile ={
        originalname: 'test.jpeg',
        size: 500,
    ...
    it('deve  lançar NotFoundException se a pessoa nao for encontrada', async() =>{
        //Arrange
      const mockFile ={
        originalname: 'test.jpeg',
        size: 2000,
